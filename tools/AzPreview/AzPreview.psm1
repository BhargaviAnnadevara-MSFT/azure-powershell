...
#
# Generated on: 09/08/2021 14:56:41
#
...
Import-Module Az.Accounts -RequiredVersion 2.2.8 -Global
Import-Module Az.Billing -RequiredVersion 0.11.0 -Global
Import-Module Az.Compute -RequiredVersion 3.3.0 -Global
Import-Module Az.DataBoxEdge -RequiredVersion 1.1.0 -Global
Import-Module Az.Dns -RequiredVersion 0.11.0 -Global
Import-Module Az.EventHub -RequiredVersion 1.4.3 -Global
Import-Module Az.IotHub -RequiredVersion 0.11.0 -Global
Import-Module Az.KeyVault -RequiredVersion 0.11.0 -Global
Import-Module Az.Monitor -RequiredVersion 1.6.0 -Global
Import-Module Az.Network -RequiredVersion 1.2.0 -Global
Import-Module Az.Resources -RequiredVersion 0.11.0 -Global
Import-Module Az.Storage -RequiredVersion 2.6.2 -Global
Import-Module Az.Websites -RequiredVersion 0.11.0 -Global
